...
endpoints=$(aws ec2 describe-vpc-endpoints --filters Name=vpc-id,Values="${CLUSTER_VPC_ID}" --query "VpcEndpoints")
...
aws ec2 delete-security-group --group-id "${EKS_CLUSTER_SG}"
