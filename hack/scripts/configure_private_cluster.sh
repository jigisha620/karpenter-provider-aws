...
# Push images to the repository from where private cluster can pull
docker push "$ACCOUNT_ID.dkr.ecr.$ECR_REGION.amazonaws.com/karpenter/snapshot/controller:643689a11697d47a19bcd98d25840589c4b31548"