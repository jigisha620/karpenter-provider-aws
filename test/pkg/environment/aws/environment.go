...
var WindowsDefaultImage = "069919849861.dkr.ecr.us-east-1.amazonaws.com/k8s/pause:3.6"

var EphemeralInitContainerImage = "069919849861.dkr.ecr.us-east-1.amazonaws.com/ecr-public/docker/library/alpine:latest"
...
func NewEnvironment(t *testing.T) *Environment {
	...
	WindowsDefaultImage = fmt.Sprintf("069919849861.dkr.ecr.%s.amazonaws.com/k8s/pause:3.6", awsEnv.Region)
	EphemeralInitContainerImage = fmt.Sprintf("069919849861.dkr.ecr.%s.amazonaws.com/ecr-public/docker/library/alpine:latest", awsEnv.Region)
	if _, awsEnv.PrivateCluster = os.LookupEnv("PRIVATE_CLUSTER"); awsEnv.PrivateCluster {
		coretest.DefaultImage = fmt.Sprintf("069919849861.dkr.ecr.%s.amazonaws.com/ecr-public/eks-distro/kubernetes/pause:3.2", awsEnv.Region)
	}
