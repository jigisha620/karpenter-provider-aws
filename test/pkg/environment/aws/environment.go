...
const PrivateClusterImage = "069919849861.dkr.ecr.us-west-2.amazonaws.com/ecr-public/eks-distro/kubernetes/pause:3.7"
...
func NewEnvironment(t *testing.T) *Environment {
	...
	if _, awsEnv.PrivateCluster = os.LookupEnv("PRIVATE_CLUSTER"); awsEnv.PrivateCluster {
		...
		WindowsDefaultImage = "069919849861.dkr.ecr.us-west-2.amazonaws.com/ecr-public/docker/library/golang:windowsservercore-ltsc2022"
	}
